    ...
    states: [
      ...
      },
      {
        ...
        lines: [
          ...
          '自宅側が整ったら、地図の「会社」から会社ネットワーク設定に進みましょう。',
          '自宅ネットワークは外部公開を行わない想定です。'
        ],
        nextAction: '自宅側が整ったので会社ページへ進み、社内ネットワークの設定を始めます。'
      }
    ],
    steps: [
      {
    ...
    states: [
      ...
      },
      {
        ...
        lines: [
          ...
          '会社構成が整ったら、自宅ページで {domain} にアクセスし、会社HPが表示されるか確認しましょう。'
        ],
        nextAction: '自宅ページに戻り、{domain} で会社HPが開けるかチェックします。'
      }
    ],
    steps: [
      {
    ...
    steps: [
      {
        id: 'home',
        title: '自宅ネットワーク',
        description: 'ONU->ルータ->PC を配置し、PC のブラウザ接続が OK になったら会社ステージへ進む。'
      },
      {
        id: 'company',
        title: '会社ネットワーク',
        description: '自宅の接続確認後、PC をサーバ用に切り替えて WEB/FTP を入れ、社内の通信経路を確認する。'
      },
      {
        id: 'ftp',
        title: 'FTP 接続確認',
        description: 'サーバ用 PC に FTP サーバアプリを入れ、接続が OK になることを確認し、自宅から会社HPを開けるか試す。'
      }
    ],
    explanations: [
      {
      ...
      },
      {
        ...
        lines: [
          '自宅ネットワークは完了しました。自宅でインターネット接続できたので、次は会社設定に進みます。',
          '会社ネットワークでは PC をサーバ用に切り替え、必要なアプリを入れて社内通信を作ります。地図の「会社」を押して進みましょう。',
      ...
      },
      {
        ...
        lines: [
          ...
          '完了後は自宅ページに戻り、会社ドメインで会社HPへ到達できるかも確認してみましょう。',
      ...
      },
      {
        ...
        lines: [
          ...
          '必要に応じて自宅ページで会社ドメイン経由のアクセスも再確認できます。',
